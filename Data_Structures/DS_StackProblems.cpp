...
//     for (int i = 0; i < n; i++)
//     {
//         c[i] = S.top();//first sets the c[i] to top and then pop to get the next last character.
//         S.pop();
//     }
// }
...
// Reversing of a Linked List using a Stack:
// #include <iostream>
// #include <conio.h>
// #include <stack>
// using namespace std;
...
//     Node* temp = head;
//     while (temp != NULL)
//     {// first pushing all the address in a stack.
//         s.push(temp);
//         temp = temp->next;
//     }
//     temp = s.top();
...
//     s.pop();
//     while (!s.empty())
//     {//using temp to dereference and reversing the link or next of the nodes.
//         temp->next = s.top();
//         s.pop();
//         temp = temp->next;
//     }
//     //setting the last link part as NULL.
//     temp->next = NULL;
...
// //Check for Balanced Paranthesis.[To be implemented]
// #include <iostream>
// #include <string.h>
// #include <stack>
// using namespace std;

// bool balancedPair(char open, char close){
//     if (open == '(' && close == ')')
//     {
//         return true;
//     }
